...
const articleCategory = __importStar(require("../../controller/admin/article-category.controller"));
const articleCategoryValidate = __importStar(require("../../validation/admin/article-category.validate"));
